<template>
  <div class="outer">
    <p class="title" v-if="device !== 'mobile'">工程案件詳細資訊列表</p>
    ...
    <div class="dataList-outer">
      <div class="banner-title-outer" v-if="device === 'desktop'">
        <div class="banner-title text-center">工程名稱</div>
        <div class="banner-title text-center">施工年度</div>
        <div class="banner-title text-center">案件承辦人(或移交單位)</div>
        <div class="banner-title text-center">施工廠商</div>
        <div class="banner-title" />
        <div class="banner-title" />
      </div>
      <div v-for="(data, index) of disasterList" :key="index">
        ...
        <div class="Warranty-text" v-if="device === 'tablet'" v-html="data.Warranty" />
      </div>
    </div>
