<template>
  <div class="outer">
    <p class="title" v-if="device !== 'mobile'">工作報告進度控管列表</p>
    ...
    <div class="dataList-outer">
      <div class="banner-title-outer" v-if="device === 'desktop'">
        ...
        <div class="banner-title text-center">案件說明</div>
      ...
      <div v-for="(data, index) of disasterList" :key="index" class="data-outer">
        ...
        <div class="dataList-Text text-align" v-html="data.startDate" />
        <div class="dataList-Text text-align" v-html="data.projectDescription" />
        <div class="dataList-Text text-align" v-if="device === 'desktop'" v-html="data.progressDescription" />
